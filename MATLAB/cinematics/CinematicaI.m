...
%theta1=; theta2=; theta3=; theta4=; theta5=; theta6=; 
 theta2=90;
 theta3=0;
 alpha1=0; alpha2=90; alpha3=0; alpha4=0; % alpha5=;  alpha6=; 
 a1=0; a2=0; a3=0; a4=0; %a5=; a6=; 
 d1=150; d4=75; %d5=; d6=;
...
A01=[ cos(theta1)  -cosd(alpha1)*sin(theta1)  sind(alpha1)*sin(theta1)  a1*cos(theta1);
     sin(theta1)  cosd(alpha1)*cos(theta1)   -sind(alpha1)*cos(theta1)  a1*sin(theta1);  
...
A34=[ cos(theta4)  -cosd(alpha4)*sin(theta4)  sind(alpha4)*sin(theta4)  a4*cos(theta4);
      sin(theta4)   cosd(alpha4)*cos(theta4) -sind(alpha4)*cos(theta4)  a4*sin(theta4);  
...
% A45=[ cos(theta5)  -cosd(alpha5)*sin(theta5)  sind(alpha5)*sin(theta5)   a5*cos(theta5);
%       sin(theta5)  cosd(alpha5)*cos(theta5)  -sind(alpha5)*cos(theta5)   a5*sin(theta5);  
...
% A56=[ cos(theta6)  -cosd(alpha6)*sin(theta6)  sind(alpha6)*sin(theta6)  a6*cos(theta6);
%       sin(theta6)  cosd(alpha6)*cos(theta6)  -sind(alpha6)*cos(theta6)  a6*sin(theta6);  
